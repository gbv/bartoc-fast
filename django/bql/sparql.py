...
class SparqlDatabase(Database):
    ...
    def setup(self) -> None:
        ...
        wb = load_workbook("//itsc-pg2.storage.p.unibas.ch/ub-home$/hinder0000/Documents/GitHub/bartoc-graphql/django/bql/fixtures/sparqlendpoints.xlsx") # required for unittest; fixtures/sparqlendpoints.xlsx in production
        for ws in wb:
            queries = []
