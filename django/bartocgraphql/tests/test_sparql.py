...
class TestSparqlEndpoint(SimpleTestCase):
    ...
    def test_search_a(self) -> None:
        ...
        for searchword in SEARCHWORDS_a:
            ...
            with open(f'//itsc-pg2.storage.p.unibas.ch/ub-home$/hinder0000/Documents/GitHub/bartoc-graphql/django/bartocgraphql/tests/files/sparql_0_{searchword}.json', encoding="utf-8") as file: 
    ...
    def test_search_b(self) -> None:
        ...
        for searchword in SEARCHWORDS_b:
            ...
            with open(f'//itsc-pg2.storage.p.unibas.ch/ub-home$/hinder0000/Documents/GitHub/bartoc-graphql/django/bartocgraphql/tests/files/sparql_1_{searchword}.json', encoding="utf-8") as file:
                correct_result = json.load(file)
                file.close()
